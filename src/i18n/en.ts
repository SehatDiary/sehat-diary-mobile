export default {
  ...
  prescription: {
    ...
    medicineStep: "Medicine %{current} of %{total}",
    confirmStep: "Check and confirm",
    summaryHint: "Tap a medicine to go back and edit it",
    notSet: "Not set",
    stepIncomplete: "Fill in the required details to continue",
    checkBeforeNext: "Check this medicine to continue",
